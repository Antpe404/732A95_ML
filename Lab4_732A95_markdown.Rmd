...
The MSEP gets minimized when I select 28 components. That is shown in the plot, and the exact values for all number of components can be extracted by the call MSEP() in R. 
