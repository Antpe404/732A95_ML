...
plot(errorrate)
############errorrate är alltså andelen rader som lägger i sv. Mao är den 1 första iterationen,
#eftersom rad två är med i sv (med setseed(12345)) är den efter 2 iteration fortf 1,
#den tredje är inte med (se sv) ergo är raten då .667. 
#Den fjärde är med ergo 3/4->.75 efter den it.
